...
import org.mikecamara.ribbit.R.array;
import org.mikecamara.ribbit.R.id;
import org.mikecamara.ribbit.R.layout;
import org.mikecamara.ribbit.R.menu;
import org.mikecamara.ribbit.R.string;
import org.mikecamara.ribbit.adapters.SectionsPagerAdapter;
...
ActionBar.TabListener{
	...
	protected DialogInterface.OnClickListener mDialogListener = new DialogInterface.OnClickListener() {
			...
			switch(which){
				...
				case 1://take video
					...
					if (mMediaUri == null) {
						...
						videoIntent.putExtra(MediaStore.EXTRA_VIDEO_QUALITY, 0); //0 the lowest
		...
		private Uri getOutputMediaFileUri(int mediaType) {
			// Check if we have memory storage external
		...
		if (resultCode == RESULT_OK) {
			...
			if (requestCode == PICK_PHOTO_REQUEST || requestCode == PICK_VIDEO_REQUEST){
				...
				if (requestCode == PICK_VIDEO_REQUEST) {
					//make sure the file is less than 10 MG
					int fileSize = 0;
